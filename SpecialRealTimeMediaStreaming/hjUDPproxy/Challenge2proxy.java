...
class Challenge2proxy {
    public static void main(String[] args) throws Exception {
        ...
        byte[] key = "streaming_key_32streaming_key_32".getBytes();	//Key for AES encryption
        SecretKeySpec skeySpec = new SecretKeySpec(key, "ChaCha20");
        ...
        while (true) {
            ...
            try {
                ...
                cipher.init(Cipher.DECRYPT_MODE, skeySpec, new IvParameterSpec(iv)); //decrypt
